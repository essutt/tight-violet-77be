...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tight-violet-77be
```

A live public deployment of this template is available at [https://tight-violet-77be.templates.workers.dev](https://tight-violet-77be.templates.workers.dev)
